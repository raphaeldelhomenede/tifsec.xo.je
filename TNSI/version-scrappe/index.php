...
// Si on appelle ?favicon.ico
if (isset($_GET['favicon_ico'])) {
    // On définit le header pour une icône
    header("Content-Type: image/x-icon");
    
    // On récupère l'image PNG distante
    $url_logo = "https://raphaeldelhomenede.github.io/tifsec/tifsec.github.io/electricite.html-5.me/img/logo_qui_fait_fuir_toutes_les_jolies_filles.png";
    
    // On l'envoie au navigateur
    echo file_get_contents($url_logo);
    exit;
}
?>
<!DOCTYPE html>
